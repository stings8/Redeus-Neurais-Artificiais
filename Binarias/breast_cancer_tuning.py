...
def criarRede(optimizer, loss, kernel_initalizer, activation, neurons):
    classificador = Sequential()
    classificador.add(Dense(units= neurons, activation= activation, 
                        kernel_initializer= kernel_initalizer, input_dim = 30))
...
parametros = {'batch_size': [10, 30], 
              ...
              'kernel_initalizer': ['random_uniform', 'normal'],
